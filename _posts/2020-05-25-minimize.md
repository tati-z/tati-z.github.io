---
layout: post
title: MINI mize — when less is more; more or less.
---

Inspired by [wuukasch](https://society6.com/product/silhouette1764749_print?sku=s6-10224347p4a1v45) and [quibe](https://society6.com/product/back-line-z1o_print)'s work, I wanted to see more of these works but most specifically, those they haven't worked on yet.
...
I'll answer that by not answering that it.

> When you keep skipping lyrics in songs, do y-

Listen, songs are on the other side of the tagent of this project.

I know you could probably just get an account with those websites where people follow people and wait on callbacks, but that wouln't work for me, because what I really want is every image I look at be minimized.

25/05/20 : 18:17: I am not sure about the *'every'* in *'every image I'd look at'*, but I know that if I find myself staring at one for even five seconds that'll be enough to break a record in a AD-Ded-brain catalog.
...
I know I will need an edge detection algorithm and I know I can trust you to not jump to conclusions.<br>
...
We agreed on the resuls we wanted to get and we both knew it didn't include bevels.

> I honestly think the bavels on white are creating a better effect than the lines we were after.
...
I was going to use adaptative threasholding. Again. and if I said yes,<br>
I..<br>
I was going to ask you to keep your mouth shut about it!
...
This is an interesting problem. The image used was esier for the algorithm to work effortlessly on similar image without loosing details. To get other images to be like this involves using smoothing algorithms that invole averaging surranding colors while aiming to keep the edges sharp.

Making this a chicken and egg problem type when what we actually want is chiken wings with crumbled eggs topping.

> ?!

To have sharp edges you need less detail. And to have less details you need smoothing. One quick way to achieve this result would be to apply smoothing and adding the edges back gradually, as doing it all in one go would give very thick edges and this is not be the desired result. Bilateral Filtering that most photo editors use to address this is also slow compared to smoothings like [Gaussian blur](https://en.wikipedia.org/wiki/Gaussian_blur).


3/ The thinckness of the stroke is also far from uniform. There are thinings that can be accomplished using morphological transformations, but the result is far from the smooth lines like the images we were inspired by. In fact, thinning could help in preparing steps that would involve tracing the contour to sample points that could be used in fitting a spline for example, such the Lanczos [Interpollation](https://stackoverflow.com/questions/1854146/what-is-the-idea-behind-scaling-an-image-using-lanczos) for the contours and [Multivariate interpolation](https://en.wikipedia.org/wiki/Multivariate_interpolation) for textures.
...
I am not going to fix any of it. I lost interest.

> Just like that?!

07/06/20 : 02:20: Nonethless, I still don't like that I was seeing noise even after applying [morphological transformations](https://arxiv.org/pdf/1203.2514.pdf).<br>

> I never mind noises/imperfections. They keep people like you up all night and I don't like sleeping early.
...
> I want the mathematical truth?

Then why did you choose the psychological lie?
...
> Yeah, say that all the time.

If a game was fair but the expertise between the players was vast. Would you consider that a fair play?

> Depends on how I'd define winning.

Look who is goal oriented now?!

<br>

> If you played a game in which the only way for you to not lose was for the other person to win. Would you play that game?

If the mathematical thruth is what you want, you can always insist explicitly.

> ...

Just because I look at you for over 5 seconds, doesn't mean I care about you mathematically speaking, because the probability that somebody cares about you given they looked at you for over 5 second is not the same as the probability that they look at you for over 5 seconds given they care about you.
<br><br><br>

> But psychology and maths aside, do you care about me?

We already agreed that I will not answer a question provided you had jumped to the conclusions.
