...
> Do you remember [that](https://youtu.be/Y0Oa4Lp5fLE) behavioural biology lecture where they said that **`sometimes a chicken is an egg's way of making other eggs`**?

Yeah haha.. imagine!

> Then could wars be peace's way of making other peace? Problems solutions' way of making other solutions?

Or the other way around.. peace as war's way of making other wars. and solutions problems's ways of making others problems.

> Parents: babies' way of making other babies, life: death's way of making other deaths, living organism: cell's way of making other cells like Covid 19. and-

Okay. We were talking about..? Yes.<br>

To have sharp edges you need smoothing. But smoothing blurs out the whole image including edges while we want both. One quick way to achieve this result would be to apply smoothing and adding the edges back gradually, as doing it all in one go would give very thick edges and this is not be the desired result. Bilateral Filtering that most photo editors use to address this is also slow compared to smoothings like [Gaussian blur](https://en.wikipedia.org/wiki/Gaussian_blur).
...
07/06/20 : 02:20: Even if I can now run a server on localhost and ship image URLs to it, or build an extension to automatically this for me and turns the whole page black/grey and white to go with it, I still don't like that I was seeing noise even after applying [morphological transformations](https://arxiv.org/pdf/1203.2514.pdf).<br>
...
I never considered they wouldn't know,..
